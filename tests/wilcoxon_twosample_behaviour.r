...
X <- matrix(x, nrow=1)
Y <- matrix(y, nrow=1)
stopifnot(all.equal(row_wilcoxon_twosample(x, y), row_wilcoxon_twosample(X, Y)))
...
X <- as.matrix(x)
Y <- as.matrix(y)
stopifnot(all.equal(suppressWarnings(row_wilcoxon_twosample(x, y)), suppressWarnings(row_wilcoxon_twosample(X, Y))))

# x and y can have 0 rows
x <- matrix(0, nrow=0, ncol=4)
y <- matrix(0, nrow=0, ncol=4)
stopifnot(all.equal(nrow(row_wilcoxon_twosample(x, y)), 0))
...
x <- rnorm(5)
y <- rnorm(5)
stopifnot(all.equal(row_wilcoxon_twosample(x, y, alternative="greater"), row_wilcoxon_twosample(x, y, alternative="g")))

# exact can be NA
x <- rnorm(5)
y <- rnorm(5)
stopifnot(all.equal(row_wilcoxon_twosample(x, y, exact=NA), row_wilcoxon_twosample(x, y, exact=TRUE)))
...
y <- 1:5
res1 <- row_wilcoxon_twosample(x, y)
res2 <- row_wilcoxon_twosample(x, rbind(y,y))
stopifnot(all.equal(res1, res2))

# null can be specified for each row
x <- matrix(rnorm(10), nrow=2)
y <- matrix(rnorm(10), nrow=2)
res1 <- row_wilcoxon_twosample(x, y, null=2)
res2 <- row_wilcoxon_twosample(x, y, null=c(2,2))
stopifnot(all.equal(res1, res2))

# alternative can be specified for each row
x <- matrix(rnorm(10), nrow=2)
y <- matrix(rnorm(10), nrow=2)
res1 <- row_wilcoxon_twosample(x, y, alternative="g")
res2 <- row_wilcoxon_twosample(x, y, alternative=c("g","g"))
stopifnot(all.equal(res1, res2))

# exact can be specified for each row
x <- matrix(rnorm(10), nrow=2)
y <- matrix(rnorm(10), nrow=2)
res1 <- row_wilcoxon_twosample(x, y, exact=TRUE)
res2 <- row_wilcoxon_twosample(x, y, exact=c(TRUE, TRUE))
stopifnot(all.equal(res1, res2))

# correct can be specified for each row
x <- matrix(rnorm(10), nrow=2)
y <- matrix(rnorm(10), nrow=2)
res1 <- row_wilcoxon_twosample(x, y, exact=FALSE, correct=FALSE)
res2 <- row_wilcoxon_twosample(x, y, exact=FALSE, correct=c(FALSE, FALSE))
stopifnot(all.equal(res1, res2))
...
y <- rnorm(10)
res1 <- row_wilcoxon_twosample(x, y)
res2 <- row_wilcoxon_twosample(x[!is.na(x)], y)
stopifnot(all.equal(res1, res2))
...
res1 <- row_wilcoxon_twosample(x, y)
res2 <- row_wilcoxon_twosample(x, y[!is.na(y)])
stopifnot(all.equal(res1, res2))
...
res1 <- row_wilcoxon_twosample(x, y)
res2 <- row_wilcoxon_twosample(x[!is.na(x)], y[!is.na(y)])
stopifnot(all.equal(res1, res2))
...
res1 <- row_wilcoxon_twosample(x1, y1)
res2 <- row_wilcoxon_twosample(x2, y2)
stopifnot(all.equal(res1, res2))

# everything can be NA
x <- rep(NA_integer_, 4)
y <- rep(NA_integer_, 4)
res <- suppressWarnings(row_wilcoxon_twosample(x, y))
...
res <- row_wilcoxon_twosample(x, y)
