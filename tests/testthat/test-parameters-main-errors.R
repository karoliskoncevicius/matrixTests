...
test_that("groups cannot be missing", {
  ...
  expect_error(oneway_welch(x=NA), er)
...
test_that("groups cannot be NULL", {
  ...
  expect_error(oneway_welch(x=matX, groups=NULL), er)
...
test_that("groups cannot be a list", {
  ...
  expect_error(oneway_welch(x=matX, groups=list(1:3)), er)
...
test_that("groups cannot be a matrix", {
  ...
  expect_error(oneway_welch(x=matX, groups=grp), er)
...
test_that("group length matches number of columns", {
  ...
  expect_error(oneway_welch(x=matX, groups=1:3), er)
